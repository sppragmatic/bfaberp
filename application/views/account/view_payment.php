            ...
            <div class="row">
                ...
                <div class="span12">
                    ...
                    <div class="search_panel">
                        <h3 class="search_header">View Payments</h3>

                        <div class="search_conent">


                            <form id="user_sch" action="<?php echo site_url("admin/account/search_payment");?>"
                                    ...
                                    <div class="span3">
                                        <div class="form-group">
                                            ...
                                            <select id="party_id" name="party_id">
                                                ...
                                                <option <?php if($pr['id']==$party_id){ ?> selected="selected"
                    ...
                    <p class="pull-right ">
                        ...
                        <a href="<?= site_url('admin/account/add_payment') ?>"><input type="button" value="New Payment"
	...
	?>
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        ...
                                        <a href="<?php echo site_url('admin/account/edit_payment')."/".$fm['id']; ?>" class="action-btn btn-edit" title="Edit Payment">
                                        ...
                                        <a href="<?php echo site_url('admin/sales/approve')."/".$fm['id']; ?>" class="action-btn btn-approve" title="Approve Payment">
                                            <i class="icon-ok"></i> Approve
                                        </a>
                                        <a href="<?php echo site_url('admin/account/chalan')."/".$fm['id']; ?>" class="action-btn btn-info" title="Print Challan">
