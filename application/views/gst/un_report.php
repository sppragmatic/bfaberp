                                    ...
                                    <div class="form-group">
                                        ...
                                        <td>
                                            ...
                                            <select id="party_id" name="party_id">
                                                ...
                                                <option <?php if($pr['code'] = $code){ ?> selected="selected" <?php } ?>
                                                    value="<?php echo $pr['code']; ?>"><?php echo $pr['name']; ?>
                                                </option>
                                                <?php } ?>
                                            </select>
                                        </td>
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo site_url('admin/account/receipt')."/".$fm['id']; ?>">Print</a>
                                    &nbsp; &nbsp;
                                    <!--<a href="<?php echo site_url('admin/account/delete')."/".$fm['id']; ?>">Delete</a>-->
                                </td>
                            </tr>
                            <?php } ?>
