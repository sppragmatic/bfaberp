...
<div class="form-group">
                ...
                <div class="col-lg-8">
			 		<input type="text" value="<?php echo $batch->name; ?>"   name="batch[name]" class="login password-field"/>
            	</div>
             </div>
			<div class="form-group">
                    <label for="text1" class="control-label col-lg-4">Start Time</label>
                <div class="col-lg-8">
			 		<input type="text" value="<?php echo $batch->start_time; ?>"   name="batch[start_time]" class="login password-field"/>
			...
			<div class="form-group">
                ...
                <div class="col-lg-8">
			 		<input type="text" value="<?php echo $batch->end_time; ?>"   name="batch[end_time]" class="login password-field"/>
                ...
                <div class="col-lg-8">
			 		<input type="text" value="<?php echo $batch->code; ?>"   name="batch[code]" class="login password-field"/>
            	</div>
             </div>
	     		...
	     		<div class="form-group">
                    <div class="col-lg-8">
						...
						<a href="<?php echo site_url()?>/admin/batch/origin_batch" class="btn btn-priamry">Origin Batch</a>
                    </div>
                </div>
	<?php echo form_close();?>
