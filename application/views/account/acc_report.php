...
<div class="span3">
   <div class="form-group">
	...
	<select id="type"    name="type">
				...
				<option <?php if($type == '1'){ ?> selected="selected" <?php } ?>  value="1">Money Receipt</option>
				<option  <?php if($type == '2'){ ?> selected="selected" <?php } ?> value="2">Payment</option>
					</select></td> 
</div>
</div>
...
<div class="span3">
   <div class="form-group">
	...
	<select id="party_id"    name="party_id">
				...
				<option <?php if($pr['code'] == $party_id ){ ?> selected="selected" <?php } ?>  value="<?php echo $pr['code']; ?>"><?php echo $pr['name']; ?></option>
				<?php } ?>
					</select></td> 
</div>
</div>
