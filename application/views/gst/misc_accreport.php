...
<table class="table table-striped table-bordered table-hover">
			...
			<tr>
<th colspan="4"><h3>Transaction Details Between  <?php echo  date('d-m-Y',strtotime($start_date)); ?> AND <?php echo  date('d-m-Y',strtotime($end_date)); ?></h3> </th>										
...
<th>Action</th>
									...
									<tbody>
<?php $sm=1;$cp=0;$dp=0; foreach ($report as $fm){
	
	$cp= $cp+$fm['credit'];
	$dp= $dp+$fm['debit'];
	?>
<tr>
<td><?php echo $fm['ent'];?></td>
<td><?php echo $fm['credit'];?></td>
<td><?php echo $fm['debit'];?></td>
<td><?php echo $fm['credit']-$fm['debit'];?></td>
<td><a href="<?php echo site_url('admin/account/view_all_acc')."/".$fm['ent']."/".date('Y-m-d',strtotime($start_date))."/".date('Y-m-d',strtotime($end_date)); ?>">View Details</a> &nbsp; </td>
</tr>
