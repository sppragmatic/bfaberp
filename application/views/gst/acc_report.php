                                    ...
                                    <div class="form-group">
                                        ...
                                        <td>
                                            ...
                                            <select id="type" name="type">
                                                ...
                                                <option <?php if($type == '1'){ ?> selected="selected" <?php } ?>
                                                    value="1">Money Receipt</option>
                                                <option <?php if($type == '2'){ ?> selected="selected" <?php } ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <td>
                                            ...
                                            <select id="party_id" name="party_id">
                                                ...
                                                <option <?php if($pr['code'] == $party_id ){ ?> selected="selected"
                                                    <?php } ?> value="<?php echo $pr['code']; ?>">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php if($fm['type']=='1'){ ?> Money Receive <?php } ?>
                                    <?php if($fm['type']=='2'){ ?>Payment <?php } ?></td>
                                <td><?php echo $fm['party_name'];?></td>
                                <td><?php echo $fm['amount'];?></td>
                                <td><?php echo $fm['remarks'];?></td>
                                <td>
                                    <!--<a href="<?php echo site_url('admin/account/edit_account')."/".$fm['id']; ?>">Edit</a> &nbsp; | &nbsp;<a href="<?php echo site_url('admin/account/delete')."/".$fm['id']; ?>">Delete</a>-->
                                </td>
                            </tr>
                            <?php } ?>
