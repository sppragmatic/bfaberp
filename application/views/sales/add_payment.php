  ...
  <div class="main-inner">
    <div class="container">
      ...
      <div class="page-header-card">
        <h1><i class="fas fa-receipt"></i> Money Receipt</h1>
        <p>Record customer payment receipt</p>
      </div>
        ...
        <div class="span12">
          <div class="widget modern-widget">
            <div class="widget-header modern-header">
              <h3><i class="fas fa-money-bill-wave"></i> MONEY RECEIPT</h3>
            </div>

            <form action="<?php echo site_url('admin/sales/add_payment')?>" method="post" class="modern-form">
