...
class Report_model extends CI_Model
{
	...
	public function __construct()
	{
		...
		function get_allform(){
			...
			return $this->db->get('admission_form')->result();
		}

		function get_form($id){
		return $this->db->get_where('admission_form',array('id'=>$id))->row();
		...
		function delete_form($id){
			$this->db->delete('admission_form',array('id'=>$id));
		}
		...
		function get_reportdata($data){
			...
			return $this->db->get_where('admission_form',$data)->result();
		}
