...
<h2>Batch</h2>
 ...
 <p class="pull-right">  
   						...
   						<a href="<?= site_url('admin/batch/create_batch') ?>"><input type="button" value="Create Batch" class="btn btn-primary"> </a></p>
 ...
 <table class="table table-striped table-bordered table-hover" id="dataTables-example">
          ...
          <?php foreach ($batch as $ctgy):?>
			...
			<td>
				...
				<a  href="<?= site_url('admin/batch/edit_batch')."/".$ctgy->id; ?>">Edit</a>
			 | <a onclick="return confirm('Are you sure  to Delete The Batch!')" href="<?= site_url('admin/batch/delete_batch')."/".$ctgy->id; ?>">Delete</a>
