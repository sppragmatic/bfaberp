  ...
  <div class="main-inner">
    <div class="container">
      ...
      <div class="page-header-card">
        <h1><i class="fas fa-edit"></i> Edit Party</h1>
        ...
        <div class="span12">
          <div class="widget modern-widget">
            <div class="widget-header modern-header">
              <h3><i class="fas fa-users"></i> EDIT PARTY</h3>
            </div>
            <form action="<?php echo site_url('admin/account/edit_party')."/".$party['id']?>" method="post" class="modern-form">
              <div class="widget-content modern-content">
<div class="table-responsive">
 <table class="table table-striped table-bordered table-hover" id="dataTables-example">
								<tr><th>Party Name</th> <td><input value="<?php echo $party['name']; ?>" name="name" type="text"></td>  </tr>
								<tr> <th>Contact No</th><td> <input name="contact_no" value="<?php echo $party['contact_no']; ?>" type="text" readonly></td>   </tr>

								<tr><th>Address</th><td><textarea name="address"><?php echo $party['address']; ?></textarea></td>  </tr>

								<tr><th>Remark</th><td><textarea name="remarks"><?php echo $party['remarks']; ?></textarea></td>  </tr>
