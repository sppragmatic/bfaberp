...
<br/>
   ...
   <form action="<?php echo site_url('admin/account/view_allfilter') ?>">
   <select name="filter">
<option value="0">All</option>
   <option value="1">Admission/installment</option>
<option value="2">Monthly</option>
<option value="3">Misc Payment</option>
<option value="4">Interview</option>
<option value="7">Rejoin</option>
</select>
...
<table class="table table-striped table-bordered table-hover">
									...
									<tr>
<th colspan="6"><h3>Transaction Details 215 Of <?php echo  date('d-m-Y',strtotime($dt)); ?></h3></th>										
...
<td><?php echo $fm['remarks'];?></td><td><?php if($fm['status']==1){  echo "Admision /Installment";  }else if($fm['status']==2){ echo "Monthly Payment";   }else if($fm['status']==3){  echo "Monthly Payment";  }else if($fm['status']==7){  echo "Rejoin";  }else{ echo "Other"; } ?></td>
...
<td><?php if($fm['status']==1){  echo "Admision /Installment";  }else if($fm['status']==2){ echo "Monthly Payment";   }else if($fm['status']==3){  echo "Monthly Payment";  }else if($fm['status']==7){  echo "Rejoin";  }{ echo "Other"; } ?></td>
<td><?php echo $fm['amt_paid'];?></td>
