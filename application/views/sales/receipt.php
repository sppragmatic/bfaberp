 ...
 <div class="challan-a5">
  ...
  <div style="display:flex; align-items:center; margin-bottom:10px;">
    <div style="flex:1; text-align:center;">
      <span style="font-size:20px; font-weight:bold; text-decoration:underline; letter-spacing:2px;">MONEY RECEIPT</span>
    </div>
  </div>
  ...
  <div class="challan-info">
    ...
    <tr>
        <td colspan="2" style="border:1.5px solid #333; background:#e0e0e0; text-align:left; padding:4px 8px;"><strong>Invoice No:</strong> <?php echo $sales['invno']; ?></td>
       
       </tr>  
       <tr>
        <td colspan="2" style="border:1.5px solid #333; background:#e0e0e0; text-align:left; padding:4px 8px;"><strong>Date:</strong> <?php echo date('d-m-Y',strtotime($sales['entry_date'])); ?></td>
      </tr>  
    
   
      <tr>
        <td colspan="2" style="border-left:1.5px solid #333; border-right:1.5px solid #333; border-bottom:1.5px solid #333; border-top:none; padding:4px 8px;"><strong>Customer:</strong> <?php echo $sales['customername']; ?></td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="2" style="border-left:1.5px solid #333; border-right:1.5px solid #333; border-bottom:1.5px solid #333; border-top:none; padding:4px 8px;"><strong>Total Amount:</strong> <?php echo $sales['debit']; ?>  (<?php echo $this->payment_model->convertNumber($sales['debit']);  ?> ) </td>
      </tr>
    </table>
  </div>
...
<div class="challan-a5">
  ...
  <div class="challan-info">
    <table style="width:100%; border-collapse:collapse; margin-bottom:8px;">
      <tr>
        <td style="border:1.5px solid #333; padding:4px 8px; width:50%;"><strong>Invoice No:</strong> <?php echo $sales['invno']; ?></td>
        <td style="border:1.5px solid #333; padding:4px 8px; width:50%;"><strong>Date:</strong> <?php echo date('d-m-Y',strtotime($sales['entry_date'])); ?></td>
      </tr>
