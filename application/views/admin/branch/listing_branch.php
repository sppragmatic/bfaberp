...
function exportToCSV() {
    ...
    var csv = 'S.No,Branch Name,Branch Code,Address\n';
...
function printTable() {
    ...
    printWindow.document.write('<html><head><title>Branch Report</title>');
    ...
    printWindow.document.write('<h2>Branch Report - ' + new Date().toLocaleDateString() + '</h2>');
...
$(document).ready(function() {
    var table = $('#branch_table').DataTable({
        ...
        "language": {
            ...
            "zeroRecords": "No matching branch records found",
            "info": "Showing _START_ to _END_ of _TOTAL_ records",
            "infoEmpty": "No records available",
            "infoFiltered": "(filtered from _MAX_ total records)",
            "processing": "Loading branch data...",
            "paginate": {
                "first": "«",
                "last": "»", 
                "next": "›",
        ...
        "initComplete": function() {
            if (!$('.table-actions').length) {
                ...
                $('#branch_table_wrapper').before(tableActions);
            }
        }
    });
...
<p class="pull-right ">  
   						...
   						<a href="<?= site_url('admin/branch/create_branch') ?>"><input type="button" value="Create Branch" class="btn btn-primary"> </a></p>
<div class="table-responsive">
<table class="table table-striped table-bordered table-hover" id="branch_table">
									<thead>
										<tr>
										<th style="text-align: center; font-weight: bold;">#</th>
										<th style="text-align: center; font-weight: bold;">Branch Name</th>
										<th style="text-align: center; font-weight: bold;">Branch Code</th>
...
<a href="<?php echo site_url('admin/branch/edit_branch/'.$fm->id); ?>" class="action-btn btn-edit" title="Edit Branch">
<i class="icon-edit"></i> Edit
</a>
<a onClick="if(confirm('Are you sure you want to delete this branch?')){location.href='<?php echo site_url('admin/branch/delete_branch/'.$fm->id);?>';}" class="action-btn btn-delete" style="cursor:pointer;" title="Delete Branch">
