...
<h3>Create customer</h3>
 ...
 <form action="<?php echo site_url('admin/sales/create_customer')?>" method="post">
 <div class="table-responsive">
 <table class="table table-striped table-bordered table-hover" id="dataTables-example">
						
						<tr><th>customer Code</th> <td><input value="<?php echo $code; ?>" name="code" readonly="readonly" type="text"></td>  </tr>
								<tr><th>customer Name</th> <td><input value="<?php echo $name; ?>" name="name" type="text"></td>  </tr>
